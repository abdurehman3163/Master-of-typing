...
//        updateUI()
    ...
    func updateUI() {
        speedProgressView.subText = "Current Speed".localized()
        accuracyProgressView.subText = "Accuracy".localized()
        ...
        avgSpeedLabel.stringValue = "\(dataManager.allStats.averageCPM) " + "CPM".localized()
        bestSpeedLabel.stringValue = "\(dataManager.allStats.bestCPM) " + "CPM".localized()
